...
function getBasicsSidebar(groupA, groupB, groupC, groupD,groupE, groupF,groupG,groupH,groupI) {
  return [{
      title: groupA,
      collapsable: false,
      children: ['/about/basics/事件流','/about/basics/数据类型','/about/basics/数组操作','/about/basics/new的过程','/about/basics/原型链', '/about/basics/闭包','/about/basics/异步', '/about/brower/事件循环','/about/brower/渲染过程', '/about/basics/arguments','/about/basics/promise','/about/basics/ts学习']
    },
    {
      title: groupB,
      collapsable: true,
    ...
    },
    {
      title: groupD,
      collapsable: true,
      children: ['/about/vue/newVue时候都做了什么','/about/vue/vue实例挂载','/about/vue/render函数','/about/vue/watch实现','/about/vue/nextTick','/about/vue/路由原理','/about/vue/生命周期', '/about/vue/自定义model', '/about/vue/异步渲染','/about/vue/响应式observe','/about/vue/虚拟DOM','/about/vue/模版渲染','/about/vue/组件通信','/about/vue/vue3']
    },
    {
      title: groupE,
      collapsable: true,
